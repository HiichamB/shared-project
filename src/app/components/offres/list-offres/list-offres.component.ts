...
export class ListOffresComponent implements OnInit {
  ...
  //   this.posts = this.posts_all.filter((texte) =>
  //     texte.translations[this.embryoService.lang]?.__designation
  //       .toLowerCase()
  //       .includes(this.filter_value.toLowerCase()),
  //   )

  //   this.posts.length ? (this.emptyResult = false) : (this.emptyResult = true)
  // }
}
